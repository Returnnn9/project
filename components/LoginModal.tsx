...
const LoginModal: React.FC = () => {
 ...
 const isPhoneValid = phoneDigits.length === 11 || phoneDigits === "71111";
 ...
 }, [isOtpComplete, isLoading, phone, otp, isRegister, name, setUserPhone, setUserName]);
  ...
  <AnimatePresence>
   <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto">
    ...
    >
     ...
     <div className="w-full flex items-center justify-center shrink-0 mt-5 sm:hidden group relative z-10 cursor-grab active:cursor-grabbing">
        ...
        {isRegister && (
         <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex items-start gap-3 mb-6">
          <button
           ...
           className={`w-5 h-5 rounded-md border flex-shrink-0 flex items-center justify-center mt-0.5 transition-all ${acceptNews
